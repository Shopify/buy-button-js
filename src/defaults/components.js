...
import dynamicCheckoutTemplates from '../templates/dynamic-checkout';
...
const defaults = {
  dynamicCheckout: {
    templates: dynamicCheckoutTemplates,
    iframe: true,
    manifest: ['dynamicCheckout'],
    layout: 'vertical',
    width: '280px',
    order: [
      'img',
    ...
    classes: {
      ...
      dynamicCheckout: 'shopify-buy__product',
