    ...
    describe('getters', () => {
      ...
      describe('document', () => {
        ...
        it('returns undefined if there is no content window document body, document body, or content document body', () => {
          iframe.el = {contentWindow: null, document: null, contentDocument: null};
